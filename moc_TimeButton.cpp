...
static const char qt_meta_stringdata_TimeButton[] = {
    "TimeButton\0"
};
...
const QMetaObjectExtraData TimeButton::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TimeButton::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_TimeButton,
      qt_meta_data_TimeButton, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TimeButton::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TimeButton))
